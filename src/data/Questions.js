export const questions = [
	...
	{
		questionText: "How many user roles available in wordpress first installation?",
		options: [
			{
				option: "4",
				isCorrect: false,
	...
	},
	{
		...
		options: [
			...
			{
				option: "XAMPP is a free and open-source cross-platform web server solution",
				isCorrect: true,
			},
		],
	},
	...
	},
	{
		...
		options: [
			...
			{
				option: "plugin is a software add-on that is installed on a program, enhancing its functionalities.",
				isCorrect: true,
			},
			{
				option: "A car name",
	...
	{
		questionText: "Which user roles doesn't come with first wordpress installation??",
		options: [
			{
				option: "Super Admin",
				isCorrect: true,
...

	{
		...
		options: [
			...
			{
				option: "Mirpur 2 Stadium e giye Dashboard > Appearance > Additional CSS",
				isCorrect: true,
			},
		],
	},
