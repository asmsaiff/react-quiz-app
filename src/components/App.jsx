				...
				<section className='min-h-screen text-lime-50 bg-slate-900 flex items-center py-12 px-4'>
					<div className='md:w-10/12 mx-auto'>
						...
						<div className='flex justify-between items-center mt-8 mb-6'>
							...
							<button onClick={this.navigateQuestion} className='text-2xl font-extrabold flex items-center gap-2 text-primary border-bottom'>
								<span>Next</span>
								<CgArrowRight />
							</button>
						</div>
						...
						<div className='space-y-6'>
							<div className='flex text-xl sm:text-4xl text-primary space-x-4'>
								...
								<span>
									{
										questions[this.state.currentQuestion].questionText
									}
								</span>
							</div>
							<div className='flex text-xl sm:text-4xl text-primary space-x-4'>
